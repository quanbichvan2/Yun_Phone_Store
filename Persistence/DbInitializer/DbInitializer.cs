...
//                    FullName = "Quan Bích Vân",
//                    Address = "Hồ Chí Minh",
//                    LockoutEnabled = false,
//                }, @"Dongvu196@").GetAwaiter().GetResult();
//                // nếu đặt pass có ký tự đặc biệt thì phải như này @"Iloveuzienoi1114@"

//                ApplicationUser user = _db.ApplicationUsers.FirstOrDefault(p => p.Email == "quanbichvan1@gmail.com")!;
